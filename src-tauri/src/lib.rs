...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            proxy::cli_sync::export_cli_config,
            proxy::cli_sync::get_cli_export_status,
            ...
            proxy::opencode_sync::export_opencode_config,
            proxy::opencode_sync::get_opencode_export_status,
            ...
            proxy::droid_sync::export_droid_config,
            proxy::droid_sync::get_droid_export_status,
